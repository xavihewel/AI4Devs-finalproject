...
describe('ScoreBadge', () => {
  ...
  it('applies correct size classes', () => {
    ...
    expect(screen.getByText('Excellent')).toHaveClass('text-xs');

    rerender(<ScoreBadge score={0.8} size="lg" />);
    expect(screen.getByText('Excellent')).toHaveClass('text-sm');
  });
